"""The 100-app research set from the assignment, across its 10 categories."""

# (app, category, hint)
APPS_100: list[tuple[str, str, str]] = [
    # 1. CRM and Sales
    ...
    ("Harvest", "Productivity and Project Management", "harvestapp.com (help.getharvest.com/api-v2)"),
...
assert len(APPS_100) == 100, f"expected 100 apps, got {len(APPS_100)}"
